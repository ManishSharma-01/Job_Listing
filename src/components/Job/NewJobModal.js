import { Box, Button, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, FilledInput, Grid, IconButton, MenuItem, Select, Typography, makeStyles } from '@material-ui/core';
    ...
    return (
        ...
        <DialogContent>
            <Grid container spacing={2}>
                ...
                fullWidth disableUnderline  variant="filled" defaultValue= "Remote">
                ...
                <Grid item xs={6}>
                    ...
                    value={jobDetails.link}
                     autoComplete='off' placeholder="Job Link *"disableUnderline fullWidth></FilledInput>
                </Grid>
                <Grid item xs={12}>
                    <FilledInput
                    onChange={handleChange}
                    ...
                    value={jobDetails.description}
                     autoComplete='off' placeholder="Job Description *"disableUnderline fullWidth multiline rows={4} ></FilledInput>
                </Grid>
            </Grid>
            <Box mt={2}>
